...
import {homeView,bottomNav,connectionsView,memoryView} from './views.mjs';
import {createConnections,createMemory} from './practice.mjs';
...
app.addEventListener('click',e=>{
  ...
  if(['home','connections','memory','practice-exit'].includes(action)){notice.textContent='';render(action==='practice-exit'?'home':action);}
